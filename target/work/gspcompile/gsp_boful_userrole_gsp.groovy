...
class gsp_boful_userrole_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/user/role.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
expressionOut.print(resource(dir:'js',file: 'role_tree.json'))
printHtmlPart(9)
})
...
public static final long LAST_MODIFIED = 1438041891721L
