...
class gsp_boful_resourceindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/resource/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(9)
expressionOut.print(resource(dir: 'images',file: 'ticon.png'))
printHtmlPart(10)
})
...
public static final long LAST_MODIFIED = 1438039788270L
